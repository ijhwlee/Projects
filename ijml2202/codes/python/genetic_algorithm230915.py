...
# 1000  -3.0782087831559024e+00 f1(x)= 99.9^sqrt((cos(sqrt(7.0/exp(exp(x1))))))+69.9+cos((((x1))*(043.14)))*x1*abs(((9.40))+log(51.0))
def ga_func_norm1(x1):
    # v = 99.19+x1/(5.69/np.log(x1+(x1))/3.2)*62.9+1.99+x1-7.7/np.sqrt(np.abs((x1)))
    v = 99.9**np.sqrt((np.cos(np.sqrt(7.0/np.exp(np.exp(x1))))))+69.9+np.cos((((x1))*(043.14)))*x1*np.abs(((9.40))+np.log(51.0))
    return v
...
# 1000  -3.5931245009892914e+00 f1(x)= 61.0+((x1*(exp(log(71.9))+cos(abs(((abs(x1)))-5.74)^x1)*19.13)))+(sin((((496.68))^(x1+(((((x1)))))^(x1))*x1*log(abs(473.54)))))
def ga_func_norm_sigma1(x1):
    ...
    v = 61.0+((x1*(np.exp(np.log(71.9))+np.cos(np.abs(((np.abs(x1)))-5.74)**x1)*19.13)))+(np.sin((((496.68))**(x1+(((((x1)))))**(x1))*x1*np.log(np.abs(473.54)))))
    return v

# use grammar.txt and N = 2000, -1.0629064570521166e+01
# no restriction for H(z) values
# 99.19+x1/(5.68/log(x1+(x1))/3.2)*62.9+01.99+x1-7.7/sqrt(abs((x1)))
# 2000  -3.0780417548441710e+00 f1(x)= 99.9^sqrt((cos(sqrt(7.0/exp(exp(x1))))))+69.9+cos((((x1))*(043.14)))*x1*abs(((9.30))+log(50.95))
def ga_func_norm2(x1):
    # v = 99.19+x1/(5.69/np.log(x1+(x1))/3.2)*62.9+1.99+x1-7.7/np.sqrt(np.abs((x1)))
    v = 99.9**np.sqrt((np.cos(np.sqrt(7.0/np.exp(np.exp(x1))))))+69.9+np.cos((((x1))*(043.14)))*x1*np.abs(((9.30))+np.log(50.95))
    return v
...
# 2000  -3.5462260256740512e+00 f1(x)= 61.0+((x1*(exp(log(71.9))+cos(abs(((abs(x1)))-5.79)^x1)*19.19)))+(sin((((496.68))^(x1+(((((x1)))))^(x1))*x1*log(abs(473.54)))))
def ga_func_norm_sigma2(x1):
    ...
    v = 61.0+((x1*(np.exp(np.log(71.9))+np.cos(np.abs(((np.abs(x1)))-5.79)**x1)*19.19)))+(np.sin((((496.68))**(x1+(((((x1)))))**(x1))*x1*np.log(np.abs(473.54)))))
    return v

# use grammar.txt and N = 10000, -8.7598459749145494e+00
# no restriction for H(z) values
# 90.45+x1/(8.96/log(x1+x1)/(428.16))*0.73^log((x1-sin(44.99/(591.0*log(x1)))))
# 10000  -2.6026992801108060e+00
# 98.3^sqrt((cos(sqrt(7.1/exp(exp(x1))))))+69.7+cos((abs(x1)*(043.11)))*x1*(((9.76))+log(91.21))-cos(((21.95)))/cos(abs(sqrt(x1)))^x1
...
# 10000  -2.6026992801108060e+00 f1(x)= 98.3^sqrt((cos(sqrt(7.1/exp(exp(x1))))))+69.7+cos((abs(x1)*(043.11)))*x1*(((9.76))+log(91.21))-cos(((21.95)))/cos(abs(sqrt(x1)))^x1
...
# 10000  -2.6523447086530139e+00 f1(x)= 61.0+(x1*(exp(log(71.6))+cos(abs(((abs(x1)))-5.79)^x1)*18.79))+(sin((((499.71))^(x1+((exp((x1))))^x1)))*(7.9*x1))+(abs(((x1))))+(x1)*sin(log((x1)))
def ga_func_norm_sigma10(x1):
    ...
    v = 61.0+(x1*(np.exp(np.log(71.6))+np.cos(np.abs(((np.abs(x1)))-5.79)**x1)*18.79))+(np.sin((((499.71))**(x1+((np.exp((x1))))**x1)))*(7.9*x1))+(np.abs(((x1))))+(x1)*np.sin(np.log((x1)))
    return v
...
# 1000  -6.3789284374338351e+00 f1(x)= (log(((((sqrt(30576514.1))^5.22)))+x1)*exp((sqrt(x1))))+x1/(log((x1)))-(log(08.0)*((log(x1))*abs(log(x1))))
def ga_func_notrig1(x1):
    ...
    v = (np.log(((((np.sqrt(30576514.1))**5.22)))+x1)*np.exp((np.sqrt(x1))))+x1/(np.log((x1)))-(np.log(08.0)*((np.log(x1))*np.abs(np.log(x1))))
    return v
...
# 1000  -4.7904064515651212e+00 f1(x)= (x1+x1+92.2+(log(x1^9.9)))-x1+sqrt(x1)+((tanh((x1)^sqrt(46.9))))*(((x1)))/x1*64.0
def ga_func_notrig_sigma1(x1):
    ...
    v = (x1+x1+92.2+(np.log(x1**9.9)))-x1+np.sqrt(x1)+((np.tanh((x1)**np.sqrt(46.9))))*(((x1)))/x1*64.0
    return v
...
# 2000  -6.3787844536601792e+00 f1(x)= (log(abs(((sqrt(30610001.1))^5.22))+x1))*exp((sqrt(x1)))+x1/(log((x1)))-(log(08.1)*((log(x1))*abs(log(x1))))
def ga_func_notrig2(x1):
    ...
    v = (np.log(np.abs(((np.sqrt(30610001.1))**5.22))+x1))*np.exp((np.sqrt(x1)))+x1/(np.log((x1)))-(np.log(08.1)*((np.log(x1))*np.abs(np.log(x1))))
    return v
...
# 2000  -4.7753623020535390e+00 f1(x)= ((x1+x1+92.2+(log(x1^9.7)))-x1*abs(x1)+(tanh((x1)^((06.4)))*(((x1)))/x1*64.97))
def ga_func_notrig_sigma2(x1):
    ...
    v = ((x1+x1+92.2+(np.log(x1**9.7)))-x1*np.abs(x1)+(np.tanh((x1)**((06.4)))*(((x1)))/x1*64.97))
    return v
...
# 10000  -5.6008045714961217e+00 f1(x)= (log(abs(((sqrt(26100411.0))^5.2))-(x1)))*exp((sqrt(x1)))+x1/(log(x1))-((log(08.5)*(log(x1))*abs(log(x1))/(((log(log(6.89+50.3)))/sqrt(x1^x1*((abs(x1)))^((x1))))-tanh((6.28))^9.17)))
def ga_func_notrig10(x1):
    ...
    v = (np.log(np.abs(((np.sqrt(26100411.0))**5.2))-(x1)))*np.exp((np.sqrt(x1)))+x1/(np.log(x1))-((np.log(08.5)*(np.log(x1))*np.abs(np.log(x1))/(((np.log(np.log(6.89+50.3)))/np.sqrt(x1**x1*((np.abs(x1)))**((x1))))-np.tanh((6.28))**9.17)))
    return v
...
# 10000  -4.7729194916090378e+00 f1(x)= tanh(x1)+x1+93.1+(log(x1^9.7))-x1*abs(x1)+(tanh((x1)^((06.4)))*((x1))/x1*65.80-abs(((tanh(5.2)^700.0))))
def ga_func_notrig_sigma10(x1):
    ...
    v = np.tanh(x1)+x1+93.1+(np.log(x1**9.7))-x1*np.abs(x1)+(np.tanh((x1)**((06.4)))*((x1))/x1*65.80-np.abs(((np.tanh(5.2)**700.0))))
    return v
...
# 1000  -5.1837225659359278e+00 f1(x)= 70.8+(70.02)^tanh(x1)+abs((x1+x1)*9.74)+tanh(x1^((45.9)))*32.70/x1^x1^1.77
def ga_func_nolog1(x1):
    # v = np.sqrt(np.exp(x1))*(70.1+np.exp(x1*4.45*x1*x1-x1*(np.exp(np.abs(x1)))**(x1))*x1)
    v = 70.8+(70.02)**np.tanh(x1)+np.abs((x1+x1)*9.74)+np.tanh(x1**((45.9)))*32.70/x1**x1**1.77
    return v
...
# 1000  -4.0554667083363443e+00 f1(x)= 9.54*(exp(x1+((tanh(exp(sqrt((sqrt(x1))^x1)-tanh((x1)))))))+4.4+x1/exp(((abs(x1^09.7/(41.36))))^4.17-x1))
...
# 2000  -4.0490420277179595e+00 f1(x)= 70.2+(70.56)^(tanh(x1))+(x1+x1)*8.93+tanh(x1^((12.0)))*47.55/x1^x1^exp(x1)*x1+sqrt(sqrt(x1^exp((x1))))^sqrt(((8.42)-((0.6))))
def ga_func_nolog2(x1):
    ...
    v = 70.2+(70.56)**(np.tanh(x1))+(x1+x1)*8.93+np.tanh(x1**((12.0)))*47.55/x1**x1**np.exp(x1)*x1+np.sqrt(np.sqrt(x1**np.exp((x1))))**np.sqrt(((8.42)-((0.6))))
    return v
...
# 2000  -4.0530306216310912e+00 f1(x)= 9.54*(exp(x1+((tanh(exp(sqrt((sqrt(x1)))^x1-tanh((x1)))))))+4.4+x1/exp(((abs(x1^((9.7))/(40.63))))^4.34-x1))
...
# 10000  -3.6858037181172549e+00 f1(x)= 70.5+((72.80))^tanh(x1)+(x1+x1)*8.21+tanh(x1^((12.9)))*47.01/x1^x1^((((x1)^abs(sqrt(sqrt(x1^exp((x1)))))^sqrt(((6.78)^sqrt(sqrt(x1)))))))+(abs((((x1)))))*(exp(x1))
...
# 10000  -3.7364715127604820e+00 f1(x)= 9.99*(exp(((x1+tanh(abs(0.7)))))+(x1^tanh((x1))+4.4+x1/exp((abs((x1))^((9.7))/(41.12))^4.09-x1)*tanh(((exp(x1)^abs((abs(exp((x1-x1))-(((x1*(exp((tanh(tanh(abs(x1)))))))))))))))))
...
# 1000  -4.7722303405148878e+00 f1(x)= udf3(04.02+x1)-(((udf1(x1)-udf3(x1))))+0.4/udf1(0.5^x1-x1^udf3(((x1)))/udf2((udf3(x1))))
def ga_func_power1(x1):
    # v = udf2(9.0)+(x1*10.47+(udf3(x1+udf1(x1)+x1)/x1-((x1**udf1((x1**1.89))))/(x1)))
    v = udf3(04.02+x1)-(((udf1(x1)-udf3(x1))))+0.4/udf1(0.5**x1-x1**udf3(((x1)))/udf2((udf3(x1))))
    return v
...
# 1000  -6.2816913123804872e+00 f1(x)= 74.46-(x1-9.88*udf2(x1)*4.9-((x1))+x1/9.3-x1-x1+(udf3(udf3(x1))/udf3(x1)^udf2(((x1-udf2(1.00))))))
def ga_func_power_sigma1(x1):
    # v = udf3(x1)*29.9/x1+udf2((8.61)+x1)-udf2(x1)**2.4
    v = 74.46-(x1-9.88*udf2(x1)*4.9-((x1))+x1/9.3-x1-x1+(udf3(udf3(x1))/udf3(x1)**udf2(((x1-udf2(1.00))))))
    return v

# use grammar_power.txt and N = 2000, -1.0640885124284996e+01
# no restriction for H(z) values
# udf2(8.0)+x1*53.77+(udf2(x1-(udf1(0.99))+(x1)))*(2.6)
# 2000  -4.5681584661512824e+00 f1(x)= udf3(04.06+(x1))-9.45*udf1(x1)+0.4/udf1(0.5/x1-x1^udf3(((x1)))/udf2((udf3(x1))))
def ga_func_power2(x1):
    # v = udf2(8.0)+x1*53.77+(udf2(x1-(udf1(0.99))+(x1)))*(2.6)
    v = udf3(04.06+(x1))-9.45*udf1(x1)+0.4/udf1(0.5/x1-x1**udf3(((x1)))/udf2((udf3(x1))))
    return v
...
# 2000  -5.8903153898262026e+00 f1(x)= 73.12-(x1-9.99*udf2(x1)*4.9-x1-x1-((3.9))*x1-x1+(udf3(udf3(x1))/udf3(x1)^udf3(((x1-udf2(1.0))))))
def ga_func_power_sigma2(x1):
    # v = udf2(x1)*29.99+udf1(udf1(udf2(8.55+x1)))-udf2(x1)**2.44+x1+x1
    v = 73.12-(x1-9.99*udf2(x1)*4.9-x1-x1-((3.9))*x1-x1+(udf3(udf3(x1))/udf3(x1)**udf3(((x1-udf2(1.0))))))
    return v
...
# 10000  -3.8350227415258598e+00 f1(x)= udf3(udf1(4.07)+x1)-9.06*(x1)+(((udf2(x1))/(1.3^x1-x1)))/udf1(udf3(((x1)))*x1-(udf1(x1)))
def ga_func_power10(x1):
    # v = 64.3+x1*(52.41)+udf2((((x1)))-0.2**x1)*(6.89+9.99/udf3((udf3(x1/(udf2(udf3(x1)))))-x1+udf3(x1))*x1)
    v = udf3(udf1(4.07)+x1)-9.06*(x1)+(((udf2(x1))/(1.3**x1-x1)))/udf1(udf3(((x1)))*x1-(udf1(x1)))
    return v
...
# 10000  -5.8463048247714724e+00 f1(x)= 72.40-(x1-9.99*udf2(x1)*4.9-x1-x1-((5.5))*x1-x1+(udf3(udf3(x1))/udf3(x1)^udf3(((x1-udf2(1.0))))))
def ga_func_power_sigma10(x1):
    ...
    v = 72.40-(x1-9.99*udf2(x1)*4.9-x1-x1-((5.5))*x1-x1+(udf3(udf3(x1))/udf3(x1)**udf3(((x1-udf2(1.0))))))
    return v
...
#define H_GA_power function, return H_GA_power_new(z_i) values
# params : parameters for power function
# H_GA(z) = a + b*z + c*z^2 - z**d
def H_GA_power_new(params, train_x):
    if np.isscalar(train_x): # single point evaluation
        z = train_x
        v = params[0] + params[1]*z + params[2]*z**2 + z**(9-3*(z-params[3])**3)
        return v
...
def H_ML_ridge(params, train_x):
    ...
    return np.array(logL) - penalty/2
...
def ML_function_lcdm(train_x):
    ...
    params = [68.133, 32.704, 24.855, -1.029, -4.040, 2.314, 0.355]
    return H_ML_orderN(params, train_x, len(params))
...
def ML_function_lsf(train_x):
    ...
    params = [55.998, 182.704, -487.777, 498.402, 96.768, -301.990, 91.969]
    return H_ML_orderN(params, train_x, len(params))
